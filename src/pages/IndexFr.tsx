      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="text-left space-y-4">
          ...
          <p className="rounded-xl border border-border bg-card p-6 space-y-4 text-align: left;">
            ...
            <br /><br />Pour palier à cela il est judicieux d'avoir des comptes en différentes devises.
            ...
            <br /><br />Ce convertisseur est un simple, il utilise Google Sheet car nous avons quasiment tous un compte Google.
